...
RANGE="Events!A:R"
HEADERS=["id","status","city","date","time","title","venue","address","price","price_text","registration","categories","description","url","source","checked_at","review_reason","editor_note"]
...
def main():
    ...
    for e in db.get("events",[]):
        rows.append([
            ...
            e.get("price_text",""),bool(e.get("registration")) if e.get("registration") is not None else "",
